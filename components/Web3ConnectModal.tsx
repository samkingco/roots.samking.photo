...
import styles from "components/Web3ConnectModal.module.css";

export default function Web3ConnectorModal() {
  const { activate, deactivate, status, error, isWrongNetwork } = useWeb3();
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <h3>Connect to your Ethereum wallet</h3>
        <TextButton onClick={closeModal}>ESC</TextButton>
      </header>
      <button
      ...
      {isWrongNetwork && <p>Please connect to the correct network.</p>}
